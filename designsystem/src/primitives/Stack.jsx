 ...
 *
 * Arranges children in a vertical column with consistent gap spacing.
 * Use Stack for any vertical list: form fields, card content, page sections.
 *
 * @param {object} props
 ...
 * @param {boolean} [props.wrap=false]       Allow wrapping to multiple columns
